...
> Except for the first two notes, this README is exactly what is provided by Udacity in this project. This is the first project in the Udacity [Intermediate Python Nanodegree](https://www.udacity.com/course/intermediate-python-nanodegree--nd303).
